...
def payment_process(request):
    ...
    request_data={
        ...
        'callback_url':request.build_absolute_url(reverse('payment:payment_callback')),#'https://codingyar.com/payment/callback',bayad address site ro ke barmigarde ro bedim
    ...
    if payment_status == 'OK':
        ...
        if "data" in res.json() and ('errors' not in res.json() or len(res.json()['errors']) == 0 ):
            ...
            if payment_code==100:
                ...
                return HttpResponse('پرداخت شما با موفقیت انجام شد البته این تراکنش ثبت شده است')
